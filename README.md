...
<!--- <p align="center"><img src=docs/bits/webapp.gif"  width="86%"></p> -->
![til](docs/bits/webapp.gif)
...
## Example pipeline
Here is an example of pipeline combining spike inference, summary and visualization for one of our datasets. You can find the combined bash script in [`pipelines/test`](pipelines/test)
...
![alt text](docs/bits/test_results.png)
