...
## Example pipeline
Here is an example of pipeline combining spike inference, summary and visualization for one of our datasets. You can find the combined bash script in [`pipelines/test`](pipeline/test)
